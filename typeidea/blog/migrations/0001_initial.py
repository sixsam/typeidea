# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-04-10 10:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('context', models.TextField(help_text='正文必须是MarkDown格式', verbose_name='正文')),
        ...
        migrations.AddField(
            model_name='post',
            name='tag',
            field=models.ManyToManyField(to='blog.Tag', verbose_name='标题'),
        ),
    ]
